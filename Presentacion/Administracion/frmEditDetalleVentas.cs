...
{
    public partial class frmEditDetalleVentas : Form
    {
        // ================== LOGICA ==================
        VentasLN olVentas = new VentasLN();
        ProductosLN olProductos = new ProductosLN();

        // ================== CONSTRUCTOR ==================
        public frmEditDetalleVentas()
        {
            InitializeComponent();
        ...
        {
            comboBox1.DataSource = olVentas.ShowVentasFiltro("");
            comboBox1.DisplayMember = "VentaID";
            comboBox1.ValueMember = "VentaID";
        ...
        // ================== CREAR OBJETO ==================
        public DetalleVentas CrearObjeto()
        {
        ...
        // ================== SET DATOS (MODIFICAR) ==================
        public void setDatos(DetalleVentas detalle)
        {
            textBox1.Text = detalle.DetalleVentaID.ToString();
            comboBox1.SelectedValue = detalle.VentaID;
        ...
        private void frmEditDetalleVentas_Load(object sender, EventArgs e)
        {
