...
namespace Datos.Administracion
{
    public class PagosCitasCD
    {
        ...
        public static void InsertarPagosCitas(Entidades.Administracion.PagosCitas oc)
        {
            DataClasses1DataContext DB = null;
            try
            {
        ...
        public static List<CP_ListarPagosCitasFiltroResult> ListarPagosCitasFiltro(string val)
        {
            DataClasses1DataContext DB = null;
            try
            {
        ...
        public static void ModificarPagosCitas(Entidades.Administracion.PagosCitas oc)
        {
            DataClasses1DataContext DB = null;
            try
            {
        ...
        public static void EliminarpPagosCitas(Entidades.Administracion.PagosCitas oc)
        {
            DataClasses1DataContext DB = null;
            try
            {
